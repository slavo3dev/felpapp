...
export default function Modal() {
  const subscribeForm = (
    <div className="flex flex-wrap max-w-lg mx-auto">
      <div className="flex w-full md:w-2/3 px-3 mb-3 md:mb-0 md:mr-6 bg-blue-500 border border-blue-300 rounded">
        ...
        <input
          className="w-full pl-3 py-4 text-xs text-white placeholder-white font-semibold leading-none bg-red-500 outline-none"
          type="text"
  ...
  return (
    <div className="px-12 py-15pc my-4">
      <section className="py-20 rounded-xl mx-auto opacity-90 bg-blue-500 w-5/6">
